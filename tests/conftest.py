...
from tests.types import ConsoleCommandEvent, EventGenerator, SupportedCommand, T


@pytest.fixture
def mock_event_gen() -> EventGenerator[SupportedCommand]:
    def _factory(command_cls: type[SupportedCommand], disable_cache: bool = False) -> ConsoleCommandEvent:
